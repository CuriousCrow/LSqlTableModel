...
void LSqlTreeModel::sort(int column, Qt::SortOrder order)
{
  //Sorting makes no sense with linked records table
}


QString LSqlTreeModel::selectAllSql()
{
...
QString LSqlTreeModel::initialRecWhere()
{
...
bool LSqlTreeModel::insertRows(int row, int count, const QModelIndex &parent)
{
...
Qt::ItemFlags LSqlTreeModel::flags(const QModelIndex &index) const
{
